...
public class MainMusicService : IMainMusicService
{
    ...
    {
        RenameFilesInDirectory(preferences.WorkingDirectory, _fileNameFixingService.FixName);
    }
    ...
    {
        var notSyncedFiles = _directorySynchronizationService
            .GetNotSyncedFiles(preferences.WorkingDirectory);
